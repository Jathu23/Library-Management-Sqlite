...
namespace Library_Api_Sqlite.Data
{
    ...
    ReturnDate TEXT NOT NULL
        ...
        (11134, '978-0-7432-7356-3', 'The Kite Runner', 'Khaled Hosseini', 'Fiction,Drama', 18, 18, 2003, '2024-09-27', 'bookimages/g (1).jpg,bookimages/g (2).jpg', 0),
        (21245, '978-0-375-50420-9', 'A Song of Ice and Fire', 'George R.R. Martin', 'Fantasy,Adventure', 25, 25, 1996, '2024-09-27', 'bookimages/g (4).jpg,bookimages/g (3).jpg', 0),
        (31356, '978-0-06-112241-5', 'Brave New World', 'Aldous Huxley', 'Dystopian,Science Fiction', 14, 14, 1932, '2024-09-27', 'bookimages/g (5).jpg,bookimages/h (4).jpg', 0),
        (41467, '978-0-618-00224-2', 'The Two Towers', 'J.R.R. Tolkien', 'Fantasy,Adventure', 25, 25, 1954, '2024-09-27', 'bookimages/g (6).jpg,bookimages/g (7).jpg', 0),
        (51578, '978-1-5011-9702-9', 'The Institute', 'Stephen King', 'Horror,Thriller', 15, 15, 2019, '2024-09-27', 'bookimages/g (8).jpg,bookimages/g (9).jpg', 0),
        (61689, '978-0-593-07353-0', 'Atomic Habits', 'James Clear', 'Self-help,Non-Fiction', 30, 30, 2018, '2024-09-27', 'bookimages/h (1.jpg', 12),
        (71790, '978-0-399-56441-3', 'Norwegian Wood', 'Haruki Murakami', 'Fiction,Romance', 9, 9, 1987, '2024-09-27', 'bookimages/h (2).jpg,norwegianwood2.jpg', 0),
        (81801, '978-1-4516-8600-5', 'Steve Jobs', 'Walter Isaacson', 'Biography,Non-Fiction', 22, 22, 2011, '2024-09-27', 'bookimages/h (3).jpg,stevejobs2.jpg', 0),
        (91912, '978-0-374-53197-2', 'Where the Crawdads Sing', 'Delia Owens', 'Fiction,Mystery', 12, 12, 2018, '2024-09-27', 'bookimages/h (2).jpg', 0),
        (102023, '978-1-250-30765-9', 'Project Hail Mary', 'Andy Weir', 'Science Fiction,Thriller', 22, 22, 2021, '2024-09-27', 'bookimages/h (3).jpg,projecthailmary2.jpg', 0);
